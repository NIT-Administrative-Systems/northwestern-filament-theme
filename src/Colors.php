...
final class Colors
{
    ...
    public const DANGER_PALETTE = [
        ...
        400 => 'oklch(0.6567 0.1600 21.239)',
        500 => 'oklch(0.5920 0.1710 21.239)',
        600 => 'oklch(0.5400 0.2020 21.239)',
    ...
    public const GRAY_PALETTE = [
        ...
        400 => 'oklch(0.740 0 31.068)',
        500 => 'oklch(0.540 0 31.068)',
        600 => 'oklch(0.475 0 31.068)',
        700 => 'oklch(0.420 0 31.068)',
